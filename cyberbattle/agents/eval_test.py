...
seeds = [2, 3, 4, 7, 8]
training_envs = [gym.make("CyberBattleRandom-v0", seed=i + 11) for i in range(10)]
...
eval_agent(training_envs, test_envs, ep, "Chain with PPO defender", defender=PPODefender(ep=ep, gamma=0.15, env=training_envs[-1]))
